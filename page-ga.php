...
<head>
    ...
    <script type="text/javascript">
        var _gaq = _gaq || [];
        _gaq.push(['_setAccount', 'UA-32394406-4']);
...
<span class="text">Tải bản từ Soha Game</span>
    ...
    <div class="infoDown" id="dataIos">
        ...
        <div class="hr"></div>
        <a href="itms-services://?action=download-manifest&url=http://www.gameb52.com/tai/<?php echo $ref?>/iPhone/B52.plist"
    ...
    <div class="infoDown" id="dataIpad">
        ...
        <div class="hr"></div>
        <a href="itms-services://?action=download-manifest&url=http://www.gameb52.com/tai/<?php echo $ref?>/iPad/B52.plist"
...
<div class="dataNews" id="dataUti">
    ...
    Bước 1: Các bạn vào trình duyệt wap địa chỉ <b>http://gameb52.com/ga</b><br>
